...
if (isset($_POST['addcontact'])){
    ...
    $phone=$_POST['phone'];
    $sql=$conn->query("INSERT INTO contact(name,email,address,phone) VALUES ('$name','$email','$address','$phone')");
    if ($sql) {
                                                        ...
                                                        <table id="zero_config" class="table table-hover">
                                                            ...
                                                            <?php
                                                                ...
                                                                <td><?php echo $row['id'] ; ?></td>
                                                                    ...
                                                                    <td><a class="btn btn-primary"  href="contactupdate.php?updatecontact=<?php echo $row['id']; ?>"  id="red">Update</a></td>
                                                                </tr>
                                                                <?php
                                                                }
                                                                ?>
