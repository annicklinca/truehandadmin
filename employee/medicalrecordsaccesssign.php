...
if(isset($_POST['signaturesubmit'])){ 
    ...
    if($category=='personal'){
     $di =$conn->query("UPDATE medicalrecordsaccess SET PersonalSignature='$signatureFileName' where id='$newid' ");
    }else{
...
<body class="bg-yellow-200">
    <div class="container">
        <div class="row">
            ...
            <a href="medicalrecordsaccess.php"><span class="bg-yellow-600 text-gray-100 font-bold py-2 px-3">Back Home  </span></a>
        </div>
    </div>
</body>
