...
if (isset($_POST['add'])){
    ...
    $sql=mysqli_query($conn,"INSERT INTO recieptinfomation(resident,residentdate,agent,agentdate,personnel,personneldate,user_id) VALUES ('$resident','$residentdate','$agent','$agentdate','$personnel','$personneldate','$user_id')");
    if ($sql) {
                                       ...
                                       <form action="" method="POST" >
                                                   <div class="form-group row">
                                                        <div class="col-sm-12">
                                                           <h3>Receipt of lnformation</h5>
                                                            ...
                                                            <label class=" col-form-label">I also acknowledge that my right to receive a copy of any developed treatment plan and discharge summary was fully explained</label>               
                                                             <label class=" col-form-label">I understand that during the course of my stay, I may c&ll or request a conference with the program director to clarify any questions that I have about any of the above items. </label>
                                                             <label class=" col-form-label">I have received a copy of the resident rights, grievance policy, and a copy of the resident guidelines. </label>    
                                                        </div>
                                                        <div class="col-sm-6">
                                        ...
                                        <div class=" table-border-style">
                                                   <div class="table-responsive">
                                                    ...
                                                    <tbody>
                                                    <?php
                                                        $quer=mysqli_query($conn,"SELECT * FROM recieptinfomation");
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn-danger"  href="delete.php?delreciept=<?php echo $row['id']; ?> " onclick="return confirm('are you sure! you want to delete this reciept of information.')" id="red">Delete</a></td>
                                                            <td><a class="btn btn-primary"  href="receiptupdate.php?updatereciept=<?php echo $row['id']; ?>"  id="red">Update</a></td>
                                                            <td><a class="btn btn-primary"  href="receiptinformationsign.php?id=<?php echo $row['id']; ?> "  id="red">Sign</a></td>
                                                            <td><a class="btn btn-success"  href="receiptinformationprint.php?printreciept=<?php echo $row['id']; ?>"  id="red">Print</a></td>
                                                        </tr>
                                                        <?php
                                                        }
                                                        ?>
                                        ...
                                        <div class=" table-border-style">
                                                   <div class="table-responsive">
                                                        <table id="zero_config" class="table table-hover">
                                                            ...
                                                            <tbody>
                                                            <?php
                                                                $quer=mysqli_query($conn,"SELECT * FROM  fileuploaded WHERE fileName='recieptinfomation' AND user_id=$user_id");
                                                                while ($row=mysqli_fetch_array($quer)){
                                                                ?>
                                                                <tr>
                                                                    <td><?php echo $row['id'] ; ?></td>
