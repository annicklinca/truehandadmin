...
include 'nav.php';
$user_id=$user_id;
$rec_id=$_GET['updategrievanceprocedures'];
...
if (isset($_POST['update'])){
    ...
    $sql=mysqli_query($conn,"UPDATE grievanceprocedures SET 
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                       ...
                                       <form action="" method="POST" >
                                           <?php
                                                if (isset($_GET['updategrievanceprocedures'])) {
                                                    $recp_id=$_GET['updategrievanceprocedures'];
                                                    $quer=mysqli_query($conn,"SELECT * FROM grievanceprocedures WHERE grievanceprocedures.id=$recp_id");
                                                ...
                                                <div class="form-group row">
                                                      ...
                                                      <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <input type="submit" name="update" value="Update Procedure"
