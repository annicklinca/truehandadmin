<?php
  ...
  $di =$conn->query("UPDATE  verificationknowledgeskills SET SupervisorSignature='$signatureFileName' where id='$newid' ");
  ...
  <body class="bg-yellow-200">
      <div class="container">
          <div class="row">
              ...
              <a href="verificationknowledgeskills.php"><span class="bg-yellow-600 text-gray-100 font-bold py-2 px-3">Back Home  </span></a>
          </div>
      </div>
  </body>
