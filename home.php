...
if (isset($_POST['addhome'])){
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'],$target)){
        $sql=mysqli_query($conn,"INSERT INTO home(title,description,photo) VALUES ('$servicetitle','$description','$image')");
        if ($sql) {
            $successmessage .='Add home content Successefully';	
        }
        else {
            $errormessage .='Add home content failed!'.$conn->error;	    
        }    
    }
    else{
        $errormessage .='Add home content failed! Try Again';
    }
}
?>
    <!-- [ Main Content ] start -->
