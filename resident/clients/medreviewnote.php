                                    ...
                                    <div class="tab-content" id="myTabContent">
                                       ...
                                       <form action="" method="POST" >
                                         <h3>Medication Management Training Checklist</h3>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                           <p>Each resident's medication stored separately</p>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-3">
                                                         <label class="col-form-label">1ST Quarter</label>
                                                            <br>
                                                            <input type="radio" name="1st_residentmedication" value="yes">yes
                                                            <input type="radio" name="1st_residentmedication" value="no">no
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <label class="col-form-label">2ST Quarter</label>
                                                            <br>
                                                            <input type="radio" name="2st_residentmedication" value="yes">yes
                                                            <input type="radio" name="2st_residentmedication" value="no">no
                                                        </div>
                                                         <div class="col-sm-3">
                                                         <label class="col-form-label">3ST Quarter</label>
                                                            <br>
                                                            <input type="radio" name="3st_residentmedication" value="yes">yes
                                                            <input type="radio" name="3st_residentmedication" value="no">no
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <label class="col-form-label">4ST Quarter</label>
                                                            <br>
                                                            <input type="radio" name="4st_residentmedication" value="yes">yes
                                                            <input type="radio" name="4st_residentmedication" value="no">no
                                                        </div>
                                                    </div>
