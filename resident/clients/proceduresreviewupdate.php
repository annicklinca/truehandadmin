<?php
 include 'nav.php';
 $user_id=$user_id;
 $rec_id=$_GET['updateproceduresreview']; 
 if (isset($_POST['updatproceduresreview'])){
    
    $PersonnelName=$_POST['PersonnelName'];
    $Supervisor=$_POST['Supervisor'];

    $sql=mysqli_query($conn,"UPDATE proceduresreview SET 
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <?php
                                                        ...
                                                        <div class="card borderless-card bg-success">
                                                            <div class="card-block success-breadcrumb">
                                                                <div class="breadcrumb-header">
                                                                    ...
                                                                    <a href="proceduresreview.php"><button class="btn btn-success">Go to proceduresreview page</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ';
                                                ...
                                                ?>
                                          <?php
                                                if (isset($_GET['updateproceduresreview'])) {
                                                    $ser_id=$_GET['updateproceduresreview'];
                                                    $quer=mysqli_query($conn,"SELECT * FROM proceduresreview WHERE proceduresreview.id=$ser_id");
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <input type="submit" name="updatproceduresreview" value="Update procedures review"
