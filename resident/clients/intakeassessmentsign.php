<?php
  ...
  if(isset($_POST['signaturesubmit'])){ 
      ...
      if($category=='client'){
  $di =$conn->query("UPDATE intakeassessment SET ClientSign='$signatureFileName' where id='$newid' ");
  
      }else if($category=='oversight'){
          $di =$conn->query("UPDATE intakeassessment  SET OversightSign='$signatureFileName' where id='$newid' ");
      }
      ...
      <div class="container">
          <div class="row">
              ...
              <select class="w-full  px-3 py-2 rounded " name="category">
                  ...
                  <option value="oversight">Clinical Oversight/BHP Signature</option>
              ...
              <a href="intakeassessment.php"><span class="bg-yellow-600 text-gray-100 font-bold py-2 px-3">Back Home  </span></a>
          </div>
      </div>
  </body>
