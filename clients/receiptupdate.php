...
if (isset($_POST['update'])){
    ...
    $sql=mysqli_query($conn,"UPDATE recieptinfomation SET 
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                       ...
                                       <form action="" method="POST" >
                                        <?php
                                                if (isset($_GET['updatereciept'])) {
                                                    $recp_id=$_GET['updatereciept'];
                                                    $quer=mysqli_query($conn,"SELECT * FROM recieptinfomation WHERE recieptinfomation.id=$recp_id");
