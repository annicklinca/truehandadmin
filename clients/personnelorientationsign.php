...
if(isset($_POST['signaturesubmit'])){ 
    ...
    $di =$conn->query("UPDATE  personnelorientation SET clinicalsupervisorsign='$signatureFileName' where id='$newid' ");
    ...
    <div class="container">
        <div class="row">
            ...
            <select class="w-full  px-3 py-2 rounded " name="category">
                <option value="clinical"> Director/ Clinical Supervisor</option>
