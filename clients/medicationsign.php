...
>>>>>>> 4da6e94967ecb0039c1dfc2b79b822c7ed5bb13d
    ...
    $di =$conn->query("UPDATE  medication SET med_signature='$signatureFileName' where id='$newid' ");
    ...
    <div class="container">
        <div class="row">
            ...
            <select class="w-full  px-3 py-2 rounded " name="category">
                <option value="clinical"> Medication </option>
            ...
            <a href="personnelorientation.php"><span class="bg-yellow-600 text-gray-100 font-bold py-2 px-3">Back Home  </span></a>
        </div>
    </div>
</body>
