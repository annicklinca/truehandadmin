...
$di =$conn->query("UPDATE moneylog SET resident_sign='$signatureFileName' where id='$newid' ");

    }else if($category=='resident'){
        $di =$conn->query("UPDATE moneylog  SET personnel_sign='$signatureFileName' where id='$newid' ");
    }
