<?php
 ...
 if (isset($_POST['updatabout'])){
   ...
   $others=$_POST['others'];
    if($image==''){
       $sql=mysqli_query($conn,"UPDATE about SET title='$title', description='$description', others='$others' WHERE id=$seri_id;");
    }else{
   $sql=mysqli_query($conn,"UPDATE about SET title='$title', description='$description', others='$others', photo='$image' WHERE id=$seri_id;");
 }
   if ($sql) {
                                        ...
                                        <?php
                                         ...
                                         <?php
                                                if (isset($_GET['updateabout'])) {
                                                    ...
                                                    $quer=mysqli_query($conn,"SELECT * FROM about WHERE about.id=$ser_id");
